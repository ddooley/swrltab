...
SWRLTabCLI is a headless command-line add-on for running SWRL inference and SQWRL queries without a GUI, developed by Damion Dooley at the [Centre for Infectious Disease Genomics and One Health (CIDGOH)](https://cidgoh.ca) at Simon Fraser University.
